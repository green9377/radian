@echo off
REM ============================================================
REM  Collections — the "Gifts for Every Budget" cards, and any
REM  other named shelf ("Valentine's", "Corporate").
REM
REM  Adds two tables: Collection and CollectionProduct, seeded
REM  with the four budget cards already on the site, so nothing
REM  changes visually until you edit them.
REM ============================================================
cd /d D:\radian
...
echo [1/3] Applying the migration (collections)...
