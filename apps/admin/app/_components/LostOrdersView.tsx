  ...
  return (
    <tr className="hover:bg-[#fcfaff]">
      ...
      <td className={CELL}>
        ...
        <div className="mt-2 grid grid-cols-[70px_1fr] gap-x-2 gap-y-[2px] rounded-[10px] border border-[#e4dbec] bg-[#faf7fc] px-2.5 py-2 text-[12.5px] leading-[1.45]">
          {lines.map((l) => (
            <span key={l.k} className="contents">
              <span className="font-medium text-[#7b6b87]">{l.k}</span>
      ...
      <td className={`${CELL} w-[200px]`}>
        <div className="flex flex-col items-start gap-1.5">
          ...
          <span className="font-medium leading-snug" style={{ color: openRow ? SOLID.red : "#7b6b87" }}>{r.reason}</span>
          {r.lastOutcome ? (
      ...
      <td className={`${CELL} w-[176px]`}>
        <div className="flex flex-col gap-1.5">
          ...
          {open && (
            <div className="mt-1 rounded-[12px] border border-[#e4dbec] bg-white p-2.5 w-[240px]">
