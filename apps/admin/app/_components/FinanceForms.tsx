  ...
  return (
    <div className={WRAP}>
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <FinHeader title="Expenses" emoji="🧾" tone="amber" sub="Rent, salary, electricity, packaging, ads — anything you pay for that does not come from a purchase order. Fixed costs feed the break-even calculation." />
...
export function IncomeLive() {
  ...
  return (
    <div className={WRAP}>
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <FinHeader title="Money in & moving" emoji="🔁" tone="emerald" sub="Income that is not a sale, and moving your own money around — bKash to bank, bank to the cash drawer. Moving money never changes profit; it only changes where the money sits." />
        {offline && <Chip tone="amber">API offline</Chip>}
      </div>
      <Flash ok={ok} err={err} />
...
export function PartnersLive() {
  ...
  return (
    <div className={WRAP}>
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <FinHeader title="Partners" emoji="🤝" tone="brand" sub="Who put how much into the business, who took how much out, and what each partner is owed. Salary is a business cost; taking money out is not — the two never mix." />
      ...
      {txn && (
        <Card className="px-5 py-4 mt-5 border-[#e7dff0]">
          ...
          <p className="text-[12.5px] text-body-soft mt-0 mb-3">
            {txn.kind === "SALARY"
              ? "This is a business cost — it reduces profit and counts towards break-even."
              : txn.kind === "CAPITAL_IN"
              ? "This is investment — it does not change profit, it increases what the business owes this partner."
              : "This is not a business cost — it reduces what the business owes this partner."}
          </p>
