  ...
  return (
    <div className={WRAP}>
      <Header
        ...
        desc="What the next week and month might look like — and how much of it is worked out rather than invented."
      />
      ...
      {anyDemo && (
        <DemoBadge text="Some figures below are invented, to show what this screen will look like. Each one says which it is, and each turns real by itself once the shop has traded long enough — nobody has to come back and change anything." />
      )}
      ...
      <div className="rounded-[16px] border border-[#3f3149] bg-white px-4 py-3.5 mb-5">
        ...
        <p className="text-[12px] text-body-soft mt-0.5 mb-3 leading-relaxed">
          ...
          so ninety empty rows do not make it ready.
        </p>
