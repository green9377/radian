...
const BLOCKS: { v: BlockType; label: string; hint: string }[] = [
  ...
  { v: "IMAGE_BANNER", label: "A picture banner", hint: "Your own creative, with a link" },
];
      ...
      <div className="rounded-[18px] border border-lavender-deep overflow-hidden bg-[var(--s-accent)] shadow-[0_2px_14px_rgba(80,40,100,0.06)]">
        ...
        >
          <div className="min-w-0">
            ...
            <div className="text-[12px] text-body-soft">Drag to reorder</div>
          </div>
        </div>
...
function ImageBannerFields({ config, onChange }: { config: Record<string, unknown>; onChange: (patch: Record<string, unknown>) => void }) {
  ...
  return (
    <div className="space-y-3">
      <F label="The picture" hint="about 1400 × 300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_1fr_160px] gap-3">
        <F label="Goes to" hint="empty = not clickable">
