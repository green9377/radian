        ...
        <div className="flex flex-col gap-1.5 mb-3">
          {list.items.map((it) => (
            ...
            >
              ...
              {it.hiddenReason && (
                <span className="text-[11.5px] text-[var(--t-warn)] shrink-0">
              ...
              <button
                ...
                className="w-[28px] h-[28px] grid place-items-center rounded-[7px] text-body-soft hover:text-[var(--t-bad)] shrink-0"
              >
      ...
      {list.items.length > 0 && (
        <div className="rounded-[12px] border border-lavender-deep bg-lavender/40 px-4 py-3 mt-1">
          ...
          <div className="space-y-1 text-[13px]">
            ...
            {list.savePaisa > 0 ? (
              <div className="flex justify-between gap-3">
                <span className="font-semibold text-[var(--t-ok)]">
