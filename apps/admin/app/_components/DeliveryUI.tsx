  ...
  return (
    <label className="block">
      <span className="text-[12.5px] font-medium text-body flex items-center gap-1.5 mb-1.5">
        {label}{required && <span className="text-[var(--t-gold)]">*</span>}
      </span>
      {children}
...
export function TimeSelect({ value, onChange, allowEmpty }: {
  ...
  return (
    <div className="inline-flex items-center border-[1.5px] border-[var(--l-accent)] rounded-[12px] bg-white overflow-hidden hover:border-[var(--l-accent)] transition-colors">
