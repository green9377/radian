    ...
    <div className={ROW + " px-4 py-3 " + (unit.isActive ? "hover:bg-lavender/25" : "bg-[#fbf5ef] hover:bg-[#f7efe7]")}>
      ...
      <button onClick={onEdit} className="min-w-0 text-left group">
        <span className="flex items-center gap-1.5 flex-wrap">
          ...
          {generic && !isBase && (
            <span className="text-[10px] font-semibold px-1.5 py-0.5 rounded-full bg-[#fff4e6] text-[#b45309]" title="A bare measure word — “Lily Stick” is safer.">
              generic name
            </span>
          )}
      ...
      <div className="text-[12.5px] min-w-0">
        {isBase ? (
          ...
          <span className="inline-flex items-center gap-1 text-[11px] font-semibold px-2 py-0.5 rounded-full bg-[#fdecea] text-[#b42318]" title="Its chain loops or is too deep.">
