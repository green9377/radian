...
const HELP =
  "Website, Facebook, WhatsApp and phone orders; walk-in counter sales have their own reports. Revenue and the average order count delivered orders only, " +
  "because that is the moment Radian recognises a sale. Every card follows the date range on the right. Product quantities count every line on a non-cancelled order.";
