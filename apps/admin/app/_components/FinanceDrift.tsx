...
function Row({ c }: { c: ApiDriftCheck }) {
  ...
  return (
    <Card className="px-4 py-4" style={{ borderColor: c.severity === "ok" ? "var(--l-accent)" : t.ring }}>
        ...
        <div className="flex-1 min-w-[240px]">
          ...
          {showMoney && (
            <div className="flex gap-5 mt-3 flex-wrap text-[13px]">
              ...
              <span className="text-body-soft">
                Difference{" "}
                <b style={{ color: c.severity === "ok" ? "var(--t-ok)" : t.text }}>
          ...
          {c.count !== undefined && (
            <div className="mt-3 text-[13px] text-body-soft">
              <b style={{ color: c.count ? t.text : "var(--t-ok)" }}>{c.count}</b>{" "}
          ...
          <div className="mt-2.5 px-3 py-2 rounded-[10px] text-[12.5px]"
            style={{ background: c.severity === "ok" ? "var(--s-ok)" : t.soft, color: c.severity === "ok" ? "var(--t-ok)" : t.text }}>
            {c.advice}
          </div>
        </div>
