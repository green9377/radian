  ...
  return (
    <div className={WRAP}>
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <FinHeader title="Monthly bills" emoji="📅" tone="amber" sub="Rent, internet, salary — the same amount every month. Set it once here and the system reminds you when it is due. Nothing goes into the books until you press post." />
...
export function StaffMoneyLive() {
  ...
  return (
    <div className={WRAP}>
      <FinHeader title="Staff advance & salary" emoji="👤" tone="sky" sub="Salary paid before payday is not a cost — it is money the staff member owes back. It becomes a cost when the salary is actually paid, and the advance is deducted there." />
      <Flash ok={ok} err={err} />
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-6">
        ...
        <Card className="px-5 py-4">
          ...
          <p className="text-[12px] text-body-soft mt-0 mb-3">
            For a leaver or a one-off. The monthly way is <Link href="/employees/payroll" className="text-orchid">Staff → Payroll</Link>,
            which pays everybody in one entry and counts the days for you.
          </p>
          <Lbl>Who</Lbl>
...
export function AccountantJournalLive() {
  ...
  return (
    <div className={WRAP}>
      <FinHeader title="Manual journal" emoji="⚖" tone="slate" sub="The only screen that speaks in debit and credit. Meant for an accountant making a year-end adjustment — everyday work never needs it. Entries here are permanent, like every other entry." />
      <Flash ok={ok} err={err} />
